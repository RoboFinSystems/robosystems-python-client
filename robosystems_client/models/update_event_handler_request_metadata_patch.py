...
T = TypeVar("T", bound="UpdateEventHandlerRequestMetadataPatch")
...
class UpdateEventHandlerRequestMetadataPatch:
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    d = dict(src_dict)
    update_event_handler_request_metadata_patch = cls()

    update_event_handler_request_metadata_patch.additional_properties = d
