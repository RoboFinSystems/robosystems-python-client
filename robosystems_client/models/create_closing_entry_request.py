...
T = TypeVar("T", bound="CreateClosingEntryRequest")


@_attrs_define
class CreateClosingEntryRequest:
  """
  Attributes:
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    create_closing_entry_request = cls(
      posting_date=posting_date,
      period_start=period_start,
      period_end=period_end,
      memo=memo,
    ...
    create_closing_entry_request.additional_properties = d
    return create_closing_entry_request
