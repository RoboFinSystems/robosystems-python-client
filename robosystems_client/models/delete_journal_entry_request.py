...
T = TypeVar("T", bound="DeleteJournalEntryRequest")
...
class DeleteJournalEntryRequest:
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    delete_journal_entry_request = cls(
      entry_id=entry_id,
    )

    delete_journal_entry_request.additional_properties = d
    return delete_journal_entry_request
