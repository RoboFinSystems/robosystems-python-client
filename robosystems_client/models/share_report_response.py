...
class ShareReportResponse:
  ...
  Attributes:
      report_id (str): The report that was shared.
      results (list[ShareResultItem]): Per-recipient outcomes. Inspect to find partial failures — the share operation
          does not fail-fast across targets.
  """
