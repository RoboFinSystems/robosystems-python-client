...
class PublishListResponse:
  ...
  Attributes:
      id (str): List identifier (ULID).
      name (str): Human-readable list name.
      created_by (str): User ID that created the list.
      created_at (datetime.datetime): When the list was created.
      updated_at (datetime.datetime): Last metadata update (name/description).
      description (None | str | Unset): Free-form description.
      member_count (int | Unset): Number of recipient graphs currently on the list. Default: 0.
  """
