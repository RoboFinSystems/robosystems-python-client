...
from ..models.operation_envelope_report_response_status import (
...
T = TypeVar("T", bound="OperationEnvelopeReportResponse")


@_attrs_define
class OperationEnvelopeReportResponse:
  """
  Attributes:
  ...
  operation: str
  operation_id: str
  status: OperationEnvelopeReportResponseStatus
  at: str
  result: None | ReportResponse | Unset = UNSET
  ...
  def to_dict(self) -> dict[str, Any]:
    ...
    if isinstance(self.result, Unset):
      result = UNSET
    elif isinstance(self.result, ReportResponse):
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    status = OperationEnvelopeReportResponseStatus(d.pop("status"))

    at = d.pop("at")

    def _parse_result(data: object) -> None | ReportResponse | Unset:
      if data is None:
        return data
      ...
      try:
        if not isinstance(data, dict):
          raise TypeError()
        result_type_0 = ReportResponse.from_dict(data)

        return result_type_0
      except (TypeError, ValueError, AttributeError, KeyError):
        pass
      return cast(None | ReportResponse | Unset, data)
    ...
    operation_envelope_report_response = cls(
      operation=operation,
    ...
    operation_envelope_report_response.additional_properties = d
    return operation_envelope_report_response
