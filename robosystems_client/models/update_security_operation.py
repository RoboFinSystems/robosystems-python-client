...
if TYPE_CHECKING:
  from ..models.update_security_operation_terms_type_0 import (
    UpdateSecurityOperationTermsType0,
  )


T = TypeVar("T", bound="UpdateSecurityOperation")
...
class UpdateSecurityOperation:
  ...
  terms: None | Unset | UpdateSecurityOperationTermsType0 = UNSET
  ...
  def to_dict(self) -> dict[str, Any]:
    ...
    if isinstance(self.terms, Unset):
      terms = UNSET
    elif isinstance(self.terms, UpdateSecurityOperationTermsType0):
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    def _parse_terms(data: object) -> None | Unset | UpdateSecurityOperationTermsType0:
      if data is None:
        return data
      if isinstance(data, Unset):
        return data
      try:
        if not isinstance(data, dict):
          raise TypeError()
        terms_type_0 = UpdateSecurityOperationTermsType0.from_dict(data)

        return terms_type_0
      except (TypeError, ValueError, AttributeError, KeyError):
        pass
      return cast(None | Unset | UpdateSecurityOperationTermsType0, data)
    ...
    update_security_operation.additional_properties = d
    return update_security_operation
