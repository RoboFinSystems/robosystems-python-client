...
from ..models.operation_envelope_taxonomy_block_envelope_status import (
...
@_attrs_define
class OperationEnvelopeTaxonomyBlockEnvelope:
  """
  Attributes:
      operation (str): Kebab-case operation name
      operation_id (str): op_-prefixed ULID for audit and SSE correlation
      status (OperationEnvelopeTaxonomyBlockEnvelopeStatus): Operation lifecycle state
      at (str): ISO-8601 UTC timestamp
      result (None | TaxonomyBlockEnvelope | Unset): Command-specific result payload
  ...
  operation: str
  operation_id: str
  status: OperationEnvelopeTaxonomyBlockEnvelopeStatus
  at: str
  result: None | TaxonomyBlockEnvelope | Unset = UNSET
  ...
  def to_dict(self) -> dict[str, Any]:
    ...
    if isinstance(self.result, Unset):
      result = UNSET
    elif isinstance(self.result, TaxonomyBlockEnvelope):
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    status = OperationEnvelopeTaxonomyBlockEnvelopeStatus(d.pop("status"))

    at = d.pop("at")

    def _parse_result(data: object) -> None | TaxonomyBlockEnvelope | Unset:
      if data is None:
        return data
      ...
      try:
        if not isinstance(data, dict):
          raise TypeError()
        result_type_0 = TaxonomyBlockEnvelope.from_dict(data)

        return result_type_0
      except (TypeError, ValueError, AttributeError, KeyError):
        pass
      return cast(None | TaxonomyBlockEnvelope | Unset, data)
    ...
    operation_envelope_taxonomy_block_envelope = cls(
      operation=operation,
    ...
    operation_envelope_taxonomy_block_envelope.additional_properties = d
