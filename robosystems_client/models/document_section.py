...
class DocumentSection:
  ...
  def to_dict(self) -> dict[str, Any]:
    ...
    entity_cik: None | str | Unset
    if isinstance(self.entity_cik, Unset):
      entity_cik = UNSET
    else:
    ...
    if entity_cik is not UNSET:
      field_dict["entity_cik"] = entity_cik
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    def _parse_entity_cik(data: object) -> None | str | Unset:
      if data is None:
        return data
      if isinstance(data, Unset):
        return data
    ...
    entity_cik = _parse_entity_cik(d.pop("entity_cik", UNSET))
