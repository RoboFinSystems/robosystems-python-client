...
T = TypeVar("T", bound="PortfolioListResponse")
...
class PortfolioListResponse:
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    d = dict(src_dict)
    portfolios = []
    _portfolios = d.pop("portfolios")
    for portfolios_item_data in _portfolios:
      portfolios_item = PortfolioResponse.from_dict(portfolios_item_data)

      portfolios.append(portfolios_item)

    pagination = PaginationInfo.from_dict(d.pop("pagination"))

    portfolio_list_response = cls(
      portfolios=portfolios,
      pagination=pagination,
    )

    portfolio_list_response.additional_properties = d
