...
T = TypeVar("T", bound="LedgerTransactionSummaryResponse")


@_attrs_define
class LedgerTransactionSummaryResponse:
  """
  Attributes:
      id (str):
      type_ (str):
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    ledger_transaction_summary_response = cls(
      id=id,
      type_=type_,
      amount=amount,
      currency=currency,
    ...
    ledger_transaction_summary_response.additional_properties = d
    return ledger_transaction_summary_response
