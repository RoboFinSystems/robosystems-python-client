...
) -> HTTPValidationError | StructureResponse | None:
  if response.status_code == 201:
    response_201 = StructureResponse.from_dict(response.json())
...
def _build_response(
  *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[HTTPValidationError | StructureResponse]:
  return Response(
...
def sync(
  ...
  *,
  ...
  Returns:
      HTTPValidationError | StructureResponse
  """
