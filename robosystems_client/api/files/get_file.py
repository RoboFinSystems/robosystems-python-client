...
) -> ErrorResponse | GetFileInfoResponse | HTTPValidationError | None:
...
def _build_response(
  *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | GetFileInfoResponse | HTTPValidationError]:
  return Response(
...
def sync(
  ...
  *,
  ...
  Returns:
      ErrorResponse | GetFileInfoResponse | HTTPValidationError
  """
