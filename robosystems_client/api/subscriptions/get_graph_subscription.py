...
def sync_detailed(
  ...
  *,
  ...
  """Get Graph Subscription
   ...
   Detects resource type automatically: user graphs (kg*) return the graph's subscription; shared
  repositories return the user's personal subscription to that repo.
