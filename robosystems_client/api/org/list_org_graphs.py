...
) -> ErrorResponse | HTTPValidationError | list[ListOrgGraphsResponse200Item] | None:
...
def _build_response(
  *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | HTTPValidationError | list[ListOrgGraphsResponse200Item]]:
  return Response(
...
def sync(
  ...
  *,
  ...
  Returns:
      ErrorResponse | HTTPValidationError | list[ListOrgGraphsResponse200Item]
  """
