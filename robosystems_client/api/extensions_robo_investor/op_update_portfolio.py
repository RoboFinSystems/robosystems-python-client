...
def _get_kwargs(
  ...
  *,
  ...
  _kwargs: dict[str, Any] = {
    "method": "post",
    "url": "/extensions/roboinvestor/{graph_id}/operations/update-portfolio".format(
...
def sync_detailed(
  ...
  *,
  ...
  """Update Portfolio
   ...
   Update mutable fields on a portfolio (name, description, strategy, inception_date, base_currency).
  Unset fields are ignored — partial updates are explicit.
  ...
  **Idempotency**: supply an `Idempotency-Key` header to make safe retries; replays within 24 hours
  ...
  Args:
      ...
      body (UpdatePortfolioOperation): CQRS body for `POST /operations/update-portfolio`.
