...
def sync_detailed(
  ...
  *,
  ...
  """Delete Portfolio
   ...
   Hard-delete a portfolio. Returns 409 if the portfolio has active positions — dispose (soft-delete)
  them first.
  ...
  **Idempotency**: supply an `Idempotency-Key` header to make safe retries; replays within 24 hours
  ...
  Args:
      ...
      body (DeletePortfolioOperation): CQRS body for `POST /operations/delete-portfolio`.
