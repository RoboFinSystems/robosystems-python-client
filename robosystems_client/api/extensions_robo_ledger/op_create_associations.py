...
def _get_kwargs(
  ...
  *,
  ...
  _kwargs: dict[str, Any] = {
    "method": "post",
    "url": "/extensions/roboledger/{graph_id}/operations/create-associations".format(
...
def sync_detailed(
  ...
  *,
  ...
  """Create Associations (Bulk)
   ...
   Create N associations in a single structure, atomically. Handles 50+ presentation arcs, 25+
  calculation arcs, or a full table linkbase in one call. Any failed row rolls back the batch.
  ...
  **Idempotency**: supply an `Idempotency-Key` header to make safe retries; replays within 24 hours
  ...
  Args:
      ...
      body (BulkCreateAssociationsRequest): Bulk create associations within a single structure.
          Atomic — any
