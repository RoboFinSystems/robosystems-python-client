...
from ...models.execute_event_block_request import ExecuteEventBlockRequest
from ...models.operation_envelope_execute_event_block_response import (
...
def _get_kwargs(
  ...
  *,
  ...
  _kwargs: dict[str, Any] = {
    "method": "post",
    "url": "/extensions/roboledger/{graph_id}/operations/execute-event-block".format(
...
def _parse_response(
  *, client: AuthenticatedClient | Client, response: httpx.Response
  ...
  if response.status_code == 200:
    response_200 = OperationEnvelopeExecuteEventBlockResponse.from_dict(response.json())
...
def sync_detailed(
  ...
  **Idempotency**: supply an `Idempotency-Key` header to make safe retries; replays within 24 hours
  ...
  Args:
      ...
      body (ExecuteEventBlockRequest): Request to publish an event to the source-of-truth
          system.
...
def sync(
  ...
  **Idempotency**: supply an `Idempotency-Key` header to make safe retries; replays within 24 hours
  ...
  Returns:
      ErrorResponse | OperationEnvelopeExecuteEventBlockResponse
  """
