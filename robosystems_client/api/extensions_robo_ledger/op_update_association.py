...
def _get_kwargs(
  ...
  *,
  ...
  _kwargs: dict[str, Any] = {
    "method": "post",
    "url": "/extensions/roboledger/{graph_id}/operations/update-association".format(
...
def sync_detailed(
  ...
  *,
  ...
  """Update Association
   ...
   Update mutable fields on an association. `from_element_id`, `to_element_id`, `association_type`, and
  `structure_id` are immutable — delete and recreate instead.
  ...
  **Idempotency**: supply an `Idempotency-Key` header to make safe retries; replays within 24 hours
  ...
  Args:
      ...
      body (UpdateAssociationRequest): Update mutable fields on an association.
          `from_element_id`,
