...
def _get_kwargs(
  ...
  *,
  ...
  _kwargs: dict[str, Any] = {
    "method": "post",
    "url": "/extensions/roboledger/{graph_id}/operations/delete-structure".format(
...
def sync_detailed(
  ...
  *,
  ...
  """Delete Structure
   ...
   Soft-delete a structure (sets `is_active=false`). Associations referencing it are effectively
  orphaned.
  ...
  **Idempotency**: supply an `Idempotency-Key` header to make safe retries; replays within 24 hours
  ...
  Args:
      ...
      body (DeleteStructureRequest): Soft delete — sets `is_active=false`.
