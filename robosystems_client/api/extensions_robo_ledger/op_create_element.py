...
def sync_detailed(
  ...
  *,
  ...
  """Create Element
   ...
   Create an element within a taxonomy. For chart-of-accounts taxonomies this is how native accounts
  are added.
  ...
  **Idempotency**: supply an `Idempotency-Key` header to make safe retries; replays within 24 hours
  ...
  Args:
      ...
      body (CreateElementRequest): Create a new Element within a taxonomy. For chart-of-accounts
