...
def _get_kwargs(
  ...
  *,
  ...
  _kwargs: dict[str, Any] = {
    "method": "post",
    "url": "/extensions/roboledger/{graph_id}/operations/delete-association".format(
...
def sync_detailed(
  ...
  *,
  ...
  """Delete Association
   ...
   Hard-delete an association. Generalizes delete-mapping-association to all association types
  ...
  **Idempotency**: supply an `Idempotency-Key` header to make safe retries; replays within 24 hours
  ...
  Args:
      ...
      body (DeleteAssociationRequest): Hard delete — associations are edges and are cheap to
          recreate.
