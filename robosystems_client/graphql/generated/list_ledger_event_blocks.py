...
class ListLedgerEventBlocks(BaseModel):
  event_blocks: list["ListLedgerEventBlocksEventBlocks"] = Field(alias="eventBlocks")


class ListLedgerEventBlocksEventBlocks(BaseModel):
  id: str
...
ListLedgerEventBlocks.model_rebuild()
